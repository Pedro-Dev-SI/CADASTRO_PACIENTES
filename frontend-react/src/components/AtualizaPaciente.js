...
export default class AtualizaPaciente extends Component {
   ...
   atualizaPaciente = (event) => {
      ...
      PacienteService.updatePaciente(paciente, this.state.id).then((response) => {
          ...
          <div className="container">
             <div className="row">
                <div className = "card col-md-6 offset-md-3 offset-md-3" style={{marginTop: "70px"}}>
                   <h2 className="texte-center">Edição de Dados Cadastrais</h2>
                   <div className="card-body">
                      <form>
                        ...
                        <button className="btn btn-success" onClick={this.atualizaPaciente.bind(this)}>Concluir</button>
